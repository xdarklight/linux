...
#define ASE_PMU(_id, _name, _func, _parent, _flags, _dev, _con) \
	PMU_GATE(ASE_PMU_GATE_##_id, _name, _func, _parent, _flags, _dev, _con)
...
void __init ase_cgu_clocks_init_compat(struct device_node *np)
{
	ase_cgu_clocks_init_dt(np);
}

static struct ltq_xway_pmu_gate ase_pmu_gates[] __initdata = {
	ASE_PMU(USB0_PHY, "usb0_phy", 0, NULL, 0, "1e101000.usb", "phy"),
	ASE_PMU(SDIO, "sdio", 2, NULL, 0, "1e103000.sdio", NULL),
	ASE_PMU(DMA, "dma", 5, NULL, 0, "1e104100.dma", NULL),
	ASE_PMU(USB0_CTRL, "usb0_ctrl", 6, NULL, 0, "1e101000.usb", "ctl"),
	ASE_PMU(EPHY, "ephy", 7, NULL, 0, "1e180000.etop", "ephy"),
	ASE_PMU(SPI, "spi", 8, NULL, 0, "1e100800.spi", NULL),
	ASE_PMU(DSL_DFE, "dsl_dfe", 9, NULL, 0, "1e116000.mei", "dfe"),
	ASE_PMU(EBU, "ebu", 10, NULL, 0, "1e105300.ebu", NULL),
	ASE_PMU(STP, "ledc", 11, NULL, 0, "1e100bb0.stp", NULL),
	ASE_PMU(GPTC, "gptu", 12, NULL, 0, "1e100a00.gptu", NULL),
	ASE_PMU(PPE_TPE, "ppe_tpe", 13, NULL, 0, "1e180000.etop", "ppe"),
	ASE_PMU(FPI0, "fpi_master", 14, NULL, CLK_IGNORE_UNUSED, "10000000.fpi", NULL),
	ASE_PMU(AHBM, "ahbm", 15, NULL, 0, NULL, NULL),
	ASE_PMU(UART1, "serial1", 17, NULL, CLK_IGNORE_UNUSED, "1e100c00.serial", NULL),
	ASE_PMU(WDT0, "wdt0", 18, NULL, CLK_IGNORE_UNUSED, NULL, NULL),
	ASE_PMU(PPE_TC, "ppe_tc", 21, NULL, 0, NULL, NULL),
	ASE_PMU(PPE_ENET0, "ppe_enet0", 23, NULL, 0, "1e180000.etop", NULL),
};
...
void __init ase_pmu_clocks_init_compat(struct device_node *np)
{
	ase_pmu_clk_gates_init_dt(np);
}
