...
void ase_cgu_clocks_init_compat(struct device_node *np)
{
...
static struct ltq_xway_pmu_gate ase_pmu_gates[] __initdata = {
	...
	ASE_PMU(PPE_DPLUS, "ppe_dplus", 23, NULL, 0, NULL, NULL),
};
...
void ase_pmu_clocks_init_compat(struct device_node *np)
{
