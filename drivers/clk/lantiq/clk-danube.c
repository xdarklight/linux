...
void __init danube_cgu_clocks_init_compat(struct device_node *np)
{
...
static struct ltq_xway_pmu_gate danube_pmu_gates[] __initdata = {
	...
	DANUBE_PMU(PPE_ENET1, "ppe_enet1", 22, NULL, 0, NULL, NULL),
	DANUBE_PMU(PPE_ENET0, "ppe_enet0", 23, NULL, 0, "1e180000.etop", NULL),
...
void __init danube_pmu_clocks_init_compat(struct device_node *np)
{
