...
static struct ltq_xway_pmu_gate danube_pmu_gates[] __initdata = {
	...
	PMU_GATE(VO_MIPS, "vo_mips", 2, NULL, CLK_IGNORE_UNUSED, NULL, NULL),
	PMU_GATE(VODEC, "vodec", 3, NULL, CLK_IGNORE_UNUSED, NULL, NULL),
	...
	PMU_GATE(WDT1, "wdt1", 19, NULL, CLK_IGNORE_UNUSED, NULL, NULL),
