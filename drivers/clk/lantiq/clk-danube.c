...
CLK_OF_DECLARE(cgu_danube, "lantiq,cgu-danube", danube_cgu_clocks_init_dt);

static struct ltq_xway_pmu_gate danube_pmu_gates[] __initdata = {
	PMU_GATE(PMU_GATE_USB0_PHY, "pmu_usb0_phy", 0, NULL, 0, NULL, NULL),
	PMU_GATE(PMU_GATE_VO_MIPS, "pmu_vo_mips", 2, NULL, CLK_IGNORE_UNUSED,
		 NULL, NULL),
	PMU_GATE(PMU_GATE_VODEC, "pmu_vodec", 3, NULL, CLK_IGNORE_UNUSED,
		 NULL, NULL),
	PMU_GATE(PMU_GATE_PCI, "pmu_pci", 4, NULL, CLK_IGNORE_UNUSED,
		 NULL, NULL),
	...
	PMU_GATE(PMU_GATE_GPTC, "pmu_gptu", 12, NULL, 0,
		 "1e100a00.gptu", NULL),
	PMU_GATE(PMU_GATE_ETOP, "pmu_etop", 13, NULL, 0,
		 "1e180000.etop", NULL),
	...
	PMU_GATE(PMU_GATE_WDT0, "pmu_wdt0", 18, NULL, CLK_IGNORE_UNUSED,
		 NULL, NULL),
	PMU_GATE(PMU_GATE_WDT1, "pmu_wdt1", 19, NULL, CLK_IGNORE_UNUSED,
		 NULL, NULL),
	PMU_GATE(PMU_GATE_DEU, "pmu_deu", 20, NULL, 0, NULL, NULL),
	PMU_GATE(PMU_GATE_PPE_TC, "pmu_ppe_tc", 21, NULL, 0, NULL, NULL),
	PMU_GATE(PMU_GATE_PPE_EMA, "pmu_ppe_enet1", 22, NULL, 0, NULL, NULL),
	PMU_GATE(PMU_GATE_PPE_DPLUM, "pmu_ppe_enet0", 23, NULL, 0, NULL, NULL),
...
CLK_OF_DECLARE(pmu_danube, "lantiq,pmu-danube", danube_pmu_clk_gates_init_dt);
