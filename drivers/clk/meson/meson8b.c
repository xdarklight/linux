...
static struct clk_fixed_factor meson8b_hdmi_pll_pre_mult = {
	.mult = 2,
	.div = 1,
	.hw.init = &(struct clk_init_data){
...
static struct clk_regmap meson8b_vid_pll = {
	...
	.hw.init = &(struct clk_init_data){
		.name = "vid_pll",
		.ops = &clk_regmap_mux_ops,
		.parent_names = (const char *[]){ "vid_pll_post_div",
			"vid_pll_pre_div", /* TODO: vid_pll_pre_div_mult7_div2 */ },
		.num_parents = 2,
		.flags = CLK_SET_RATE_PARENT,
	},
};
...
static struct clk_hw_onecell_data meson8b_hw_onecell_data = {
	.hws = {
		...
		[CLKID_HDMI_PLL_PRE_MULT]   = &meson8b_hdmi_pll_pre_mult.hw,
