...
static struct clk_regmap meson8b_vid_pll_post_sel = {
	.data = &(struct clk_regmap_mux_data){
		.offset = HHI_VID_DIVIDER_CNTL,
		.mask = 0x3,
		.shift = 8,
...
static struct clk_regmap meson8b_vid_pll_post_en = {
	.data = &(struct clk_regmap_gate_data){
		.offset = HHI_VID_DIVIDER_CNTL,
		.bit_idx = 16,
	},
...
static struct clk_regmap meson8b_vclk_sel = {
	.data = &(struct clk_regmap_mux_data){
...
static struct clk_regmap meson8b_vclk_en0_gate = {
	.data = &(struct clk_regmap_gate_data){
		.offset = HHI_VID_CLK_CNTL,
		.bit_idx = 19,
	},
...
static struct clk_regmap meson8b_vclk_xd0_div = {
	.data = &(struct clk_regmap_div_data){
...
static struct clk_regmap meson8b_vclk_clk_div_gate = {
	.data = &(struct clk_regmap_gate_data){
		.offset = HHI_VID_CLK_DIV,
		.bit_idx = 16,
	},
...
static struct clk_regmap meson8b_vclk_div2_gate = {
	.data = &(struct clk_regmap_gate_data){
		.offset = HHI_VID_CLK_DIV,
		.bit_idx = 1,
	},
...
static struct clk_regmap meson8b_vclk_div4_gate = {
	.data = &(struct clk_regmap_gate_data){
		.offset = HHI_VID_CLK_DIV,
		.bit_idx = 2,
	},
...
static struct clk_regmap meson8b_vclk_div6_gate = {
	.data = &(struct clk_regmap_gate_data){
		.offset = HHI_VID_CLK_DIV,
		.bit_idx = 3,
	},
...
static struct clk_regmap meson8b_vclk_div12_gate = {
	.data = &(struct clk_regmap_gate_data){
		.offset = HHI_VID_CLK_DIV,
		.bit_idx = 4,
	},
...
static struct clk_regmap meson8b_vclk2_sel = {
	.data = &(struct clk_regmap_mux_data){
...
static struct clk_regmap meson8b_vclk2_en0_gate = {
	.data = &(struct clk_regmap_gate_data){
		.offset = HHI_VIID_CLK_CNTL,
		.bit_idx = 19,
	},
...
static struct clk_regmap meson8b_vclk2_xd0_div = {
	.data = &(struct clk_regmap_div_data){
...
static struct clk_regmap meson8b_vclk2_clk_div_gate = {
	.data = &(struct clk_regmap_gate_data){
		.offset = HHI_VIID_CLK_DIV,
		.bit_idx = 16,
	},
...
static struct clk_regmap meson8b_vclk2_div2_gate = {
	.data = &(struct clk_regmap_gate_data){
		.offset = HHI_VIID_CLK_DIV,
		.bit_idx = 1,
	},
...
static struct clk_regmap meson8b_vclk2_div4_gate = {
	.data = &(struct clk_regmap_gate_data){
		.offset = HHI_VIID_CLK_DIV,
		.bit_idx = 2,
	},
...
static struct clk_regmap meson8b_vclk2_div6_gate = {
	.data = &(struct clk_regmap_gate_data){
		.offset = HHI_VIID_CLK_DIV,
		.bit_idx = 3,
	},
...
static struct clk_regmap meson8b_vclk2_div12_gate = {
	.data = &(struct clk_regmap_gate_data){
		.offset = HHI_VIID_CLK_DIV,
		.bit_idx = 4,
	},
...
static struct clk_regmap meson8b_enct_sel = {
	.data = &(struct clk_regmap_mux_data){
		.offset = HHI_VID_CLK_DIV,
		.mask = 0xf,
		.shift = 20,
...
static struct clk_regmap meson8b_enct_gate = {
	.data = &(struct clk_regmap_gate_data){
...
static struct clk_regmap meson8b_encp_sel = {
	.data = &(struct clk_regmap_mux_data){
		.offset = HHI_VID_CLK_DIV,
		.mask = 0xf,
		.shift = 24,
...
static struct clk_regmap meson8b_encp_gate = {
	.data = &(struct clk_regmap_gate_data){
		.offset = HHI_VID_CLK_CNTL2,
		.bit_idx = 2,
	},
...
static struct clk_regmap meson8b_enci_sel = {
	.data = &(struct clk_regmap_mux_data){
		.offset = HHI_VID_CLK_DIV,
		.mask = 0xf,
		.shift = 28,
...
static struct clk_regmap meson8b_enci_gate = {
	.data = &(struct clk_regmap_gate_data){
		.offset = HHI_VID_CLK_CNTL2,
		.bit_idx = 0,
	},
...
static struct clk_regmap meson8b_encl_sel = {
	.data = &(struct clk_regmap_mux_data){
		.offset = HHI_VIID_CLK_DIV,
		.mask = 0xf,
		.shift = 12,
...
static struct clk_regmap meson8b_encl_gate = {
	.data = &(struct clk_regmap_gate_data){
		.offset = HHI_VID_CLK_CNTL2,
		.bit_idx = 3,
	},
...
static struct clk_regmap meson8b_vdac0_sel = {
	.data = &(struct clk_regmap_mux_data){
		.offset = HHI_VIID_CLK_DIV,
		.mask = 0xf,
		.shift = 28,
...
static struct clk_regmap meson8b_vdac0_gate = {
	.data = &(struct clk_regmap_gate_data){
		.offset = HHI_VID_CLK_CNTL2,
		.bit_idx = 4,
	},
...
static struct clk_regmap meson8b_hdmi_tx_pixel_gate = {
	.data = &(struct clk_regmap_gate_data){
		.offset = HHI_VID_CLK_CNTL2,
		.bit_idx = 5,
	},
				       ...
				       unsigned long event, void *data)
{
	...
	struct clk_hw *cpu_clk_hw = hws[CLKID_CPUCLK];
