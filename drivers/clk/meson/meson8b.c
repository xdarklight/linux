...
static struct clk_fixed_factor meson8b_xtal_mult2 = {
	.mult = 2,
	.div = 1,
	.hw.init = &(struct clk_init_data){
		.name = "xtal_mult2",
...
static struct clk_fixed_factor meson8b_xtal_mult4 = {
	.mult = 4,
	.div = 1,
	.hw.init = &(struct clk_init_data){
		.name = "xtal_mult4",
...
static struct clk_regmap meson8b_vid_pll_fb_od = {
	.data = &(struct clk_regmap_mux_data){
		.offset = HHI_VID_PLL_CNTL4,
		.mask = 0x1,
		.shift = 24,
	},
	.hw.init = &(struct clk_init_data){
		...
		.parent_names = (const char *[]){ "xtal_mult2", "xtal_mult4" },
		.num_parents = 2,
	},
};

static const struct pll_params_table vid_pll_params_table[] = {
	PLL_PARAMS(40, 2),
	PLL_PARAMS(42, 2),
	PLL_PARAMS(44, 2),
	PLL_PARAMS(45, 2),
	PLL_PARAMS(49, 2),
	PLL_PARAMS(52, 2), // Meson8b only for VMODE_640X480P_75HZ
	PLL_PARAMS(54, 2),
	PLL_PARAMS(56, 2), // Meson8b only for VMODE_1280X1024P_75HZ
	PLL_PARAMS(59, 2),
	PLL_PARAMS(60, 2),
	PLL_PARAMS(61, 2),
	PLL_PARAMS(66, 2),
	PLL_PARAMS(68, 2), // Meson8b only for VMODE_1024X768P_75HZ
	PLL_PARAMS(71, 2),
	PLL_PARAMS(82, 2), // Meson8b only for VMODE_800X600P_75HZ
	{ /* sentinel */ },
};
...
static struct clk_regmap meson8b_vid_pll_dco = {
	.data = &(struct meson_clk_pll_data){
		...
		.table = vid_pll_params_table,
	},
	.hw.init = &(struct clk_init_data){
		.name = "vid_pll_dco",
		.ops = &meson_clk_pll_ro_ops,
		.parent_names = (const char *[]){ "vid_pll_fb_od" },
		.num_parents = 1,
	},
};

static struct clk_regmap meson8b_vid_pll_lvds_od = {
	.data = &(struct clk_regmap_div_data){
...
static struct clk_hw_onecell_data meson8b_hw_onecell_data = {
	.hws = {
		...
		[CLKID_XTAL_MULT2]	    = &meson8b_xtal_mult2.hw,
		[CLKID_XTAL_MULT4]	    = &meson8b_xtal_mult4.hw,
		[CLKID_VID_PLL_FB_OD]	    = &meson8b_vid_pll_fb_od.hw,
...
static struct clk_regmap *const meson8b_clk_regmaps[] = {
	...
	&meson8b_vid_pll_fb_od,
	&meson8b_vid_pll_lvds_od,
