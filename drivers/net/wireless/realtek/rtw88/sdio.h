...
#define REG_SDIO_TX_CTRL_CMD_ERR_STOP_INT_EN	BIT(0)
#define REG_SDIO_TX_CTRL_EN_MASK_TIMER		BIT(1)
#define REG_SDIO_TX_CTRL_EN_RXDMA_MASK_INT	BIT(2)
#define REG_SDIO_TX_CTRL_EN_32K_TRANS		BIT(3)
#define REG_SDIO_TX_CTRL_RXINT_READ_MASK_DIS	BIT(3)
#define REG_SDIO_TX_CTRL_INIT_CMD_EN		BIT(4)
#define REG_SDIO_TX_CTRL_SDIO_CMD_FORCE_VLD	BIT(5)
#define REG_SDIO_TX_CTRL_R18A_EN		BIT(6)
#define REG_SDIO_TX_CTRL_REPLY_ERR_IN_R5	BIT(7)
#define REG_SDIO_TX_CTRL_EN_CMD53_OVERLAP	BIT(8)
#define REG_SDIO_TX_CTRL_REPLY_ERRCRC_IN_DATA	BIT(9)
#define REG_SDIO_TX_CTRL_CMD53_R_TIMEOUT_MASK	BIT(12)
#define REG_SDIO_TX_CTRL_CMD53_TX_FORMAT	BIT(13)
#define REG_SDIO_TX_CTRL_CMD53_W_MIX		BIT(14)
#define REG_SDIO_TX_CTRL_IO_ERR_STATUS		BIT(15)
