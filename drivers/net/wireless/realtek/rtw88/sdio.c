...
static u32 rtw_sdio_readl(struct rtw_sdio *rtwsdio, u32 addr, int *err_ret)
{
	u8 buf[4];
	int i;
				  ...
				  int *err_ret)
{
	...
	rtw_sdio_writel(rtwsdio, BIT(19) | addr, reg_cfg, err_ret);
	if (*err_ret)
		return 0;
				    ...
				    int *err_ret)
{
	...
	rtw_sdio_writel(rtwsdio, BIT(19) | BIT(17) | addr, reg_cfg, err_ret);
	if (*err_ret)
		return 0;
	...
	return rtw_sdio_readl(rtwsdio, reg_data, err_ret);;
}
