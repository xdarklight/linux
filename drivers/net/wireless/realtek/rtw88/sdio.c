...
static int rtw_sdio_tx(struct rtw_dev *rtwdev, u8 queue)
{
	...
	// TODO: replace with something like: fill_txdesc_agg_num(skb_agg->data, num_aggregated_skbs);
	le32p_replace_bits((__le32 *)(skb_agg->data) + 0x07, num_aggregated_skbs + 1, GENMASK(31, 24));
