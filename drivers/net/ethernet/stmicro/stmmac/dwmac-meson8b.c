...
static void meson8b_dwmac_rgmii_tx_clk_disable(void *data)
{
	struct meson8b_dwmac *dwmac = data;

	clk_disable_unprepare(dwmac->rgmii_tx_clk);
}
...
static int meson8b_init_prg_eth(struct meson8b_dwmac *dwmac)
{
	...
	case PHY_INTERFACE_MODE_RGMII_TXID:
		...
		devm_add_action_or_reset(&dwmac->pdev->dev,
					 meson8b_dwmac_rgmii_tx_clk_disable,
					 dwmac);
		break;
