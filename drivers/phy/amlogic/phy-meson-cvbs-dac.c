...
#define HHI_VDAC_CNTL0		0x0
#define HHI_VDAC_CNTL1		0x4
...
static const struct reg_field phy_meson_cvbs_dac_reg_fields[MESON_CVBS_DAC_NUM_REGS] = {
	[MESON_CDAC_CTRL_RESV1] =	REG_FIELD(HHI_VDAC_CNTL0, 0, 7),
	[MESON_CDAC_CTRL_RESV2] =	REG_FIELD(HHI_VDAC_CNTL0, 8, 15),
	[MESON_CDAC_VREF_ADJ] =		REG_FIELD(HHI_VDAC_CNTL0, 16, 20),
	[MESON_CDAC_RL_ADJ] =		REG_FIELD(HHI_VDAC_CNTL0, 21, 23),
	[MESON_CDAC_CLK_PHASE_SEL] =	REG_FIELD(HHI_VDAC_CNTL0, 24, 24),
	[MESON_CDAC_DRIVER_ADJ] =	REG_FIELD(HHI_VDAC_CNTL0, 25, 25),
	[MESON_CDAC_EXT_VREF_EN] =	REG_FIELD(HHI_VDAC_CNTL0, 26, 26),
	[MESON_CDAC_BIAS_C] =		REG_FIELD(HHI_VDAC_CNTL0, 27, 27),
	[MESON_VDAC_CNTL0_RESERVED] =	REG_FIELD(HHI_VDAC_CNTL0, 28, 31),
	[MESON_CDAC_GSW] =		REG_FIELD(HHI_VDAC_CNTL1, 0, 2),
	[MESON_CDAC_PWD] =		REG_FIELD(HHI_VDAC_CNTL1, 3, 3),
	[MESON_VDAC_CNTL1_RESERVED] =	REG_FIELD(HHI_VDAC_CNTL1, 4, 31),
};
