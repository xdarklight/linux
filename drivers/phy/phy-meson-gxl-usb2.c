...
#define U2P_R0							0x0
	...
	#define U2P_R0_FSEL_MASK				GENMASK(17, 19)
	#define U2P_R0_REF_CLK_SEL_SHIFT			20
	#define U2P_R0_REF_CLK_SEL_MASK				GENMASK(20, 21)
	#define U2P_R0_POWER_ON_RESET				BIT(22)
	#define U2P_R0_V_ATE_TEST_EN_B_SHIFT			23
	#define U2P_R0_V_ATE_TEST_EN_B_MASK			GENMASK(23, 24)
...
#define U2P_R1							0x4
	...
	#define U2P_R1_TX_PREEMP_AMP_TUNE_MASK			GENMASK(7, 8)
	#define U2P_R1_TX_RES_TUNE_SHIFT			9
	#define U2P_R1_TX_RES_TUNE_MASK				GENMASK(9, 10)
	#define U2P_R1_TX_RISE_TUNE_SHIFT			11
	#define U2P_R1_TX_RISE_TUNE_MASK			GENMASK(11, 12)
	#define U2P_R1_TX_VREF_TUNE_SHIFT			13
	#define U2P_R1_TX_VREF_TUNE_MASK			GENMASK(13, 16)
	#define U2P_R1_TX_FSLS_TUNE_SHIFT			17
	#define U2P_R1_TX_FSLS_TUNE_MASK			GENMASK(17, 20)
	#define U2P_R1_TX_HSXV_TUNE_SHIFT			21
	#define U2P_R1_TX_HSXV_TUNE_MASK			GENMASK(21, 22)
	#define U2P_R1_OTG_TUNE_SHIFT				23
	#define U2P_R1_OTG_TUNE_MASK				GENMASK(23, 25)
	#define U2P_R1_SQRX_TUNE_SHIFT				26
	#define U2P_R1_SQRX_TUNE_MASK				GENMASK(26, 28)
	#define U2P_R1_COMP_DIS_TUNE_SHIFT			29
	#define U2P_R1_COMP_DIS_TUNE_MASK			GENMASK(29, 31)

#define U2P_R2							0x8
	#define U2P_R2_DATA_IN_SHIFT				0
	#define U2P_R2_DATA_IN_MASK				GENMASK(0, 3)
	#define U2P_R2_DATA_IN_EN_SHIFT				4
	#define U2P_R2_DATA_IN_EN_MASK				GENMASK(4, 7)
	#define U2P_R2_ADDR_SHIFT				8
	#define U2P_R2_ADDR_MASK				GENMASK(8, 11)
	#define U2P_R2_DATA_OUT_SEL				BIT(12)
	#define U2P_R2_CLK					BIT(13)
	#define U2P_R2_DATA_OUT_SHIFT				14
	#define U2P_R2_DATA_OUT_MASK				GENMASK(14, 17)
...
static u32 phy_meson_gxl_usb2_read(struct phy_meson_gxl_usb2_priv *priv, u32 reg)
{
	return readl(priv->regs + reg);
}

static void phy_meson_gxl_usb2_mask_bits(struct phy_meson_gxl_usb2_priv *priv,
					 u32 reg, u32 mask, u32 value)
{
	u32 data;

	data = phy_meson_gxl_usb2_read(priv, reg);
	data &= ~mask;
	data |= (value & mask);
...
static int phy_meson_gxl_usb2_set_mode(struct phy *phy, enum phy_mode mode)
{
	...
	case PHY_MODE_USB_OTG:
		phy_meson_gxl_usb2_mask_bits(priv, U2P_R0, U2P_R0_DM_PULLDOWN,
					     U2P_R0_DM_PULLDOWN);
		phy_meson_gxl_usb2_mask_bits(priv, U2P_R0, U2P_R0_DP_PULLDOWN,
					     U2P_R0_DP_PULLDOWN);
		phy_meson_gxl_usb2_mask_bits(priv, U2P_R0, U2P_R0_ID_PULLUP,
					     0);
		break;
	...
	/* reset the PHY */
	phy_meson_gxl_usb2_mask_bits(priv, U2P_R0, U2P_R0_POWER_ON_RESET,
				     U2P_R0_POWER_ON_RESET);
	udelay(RESET_COMPLETE_TIME);
	phy_meson_gxl_usb2_mask_bits(priv, U2P_R0, U2P_R0_POWER_ON_RESET, 0);
	udelay(RESET_COMPLETE_TIME);

	{
		int i;
		for (i = 0; i < 0x20; i+=0x4)
			printk("0x%lx = 0x%08x\n", priv->regs + i, phy_meson_gxl_usb2_read(priv, i));
	}
...
static int phy_meson_gxl_usb2_power_on(struct phy *phy)
{
	...
	ret = phy_meson_gxl_usb2_set_mode(phy, mode);
	if (ret) {
