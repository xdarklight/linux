...
#define TX_AUDIO_FIFO							0x005B
	#define TX_AUDIO_FIFO_FIFO_DEPTH			GENMASK(7, 4)
	#define TX_AUDIO_FIFO_CRITICAL_THRESHOLD		GENMASK(3, 2)
	#define TX_AUDIO_FIFO_NORMAL_TRESHOLD			GENMASK(1, 0)
...
#define TX_AUDIO_CONTROL						0x005D
	...
	#define TX_AUDIO_CONTROL_AUDIO_PACKET_TYPE		GENMASK(5, 4)
