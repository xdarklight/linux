					  ...
					  struct hdmi_codec_params *hparms)
{
	...
	regmap_write(priv->tx_regmap, TX_AUDIO_FORMAT, audio_format);
	...
	regmap_write(priv->tx_regmap, TX_AUDIO_I2S, audio_i2s);
	regmap_write(priv->tx_regmap, TX_AUDIO_SPDIF, audio_spdif);
