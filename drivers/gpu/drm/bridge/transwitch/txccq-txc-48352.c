...
static u8 txc_48352_bus_fmt_color_depth(unsigned int bus_format)
{
	switch (bus_format) {
...
static u8 txc_48352_bus_fmt_color_format(unsigned int bus_format)
{
...
struct txc_48352 *txc_48352_probe(struct device *dev)
{
...
EXPORT_SYMBOL_GPL(txc_48352_probe);

void txc_48352_remove(struct txc_48352 *priv)
{
	drm_bridge_remove(&priv->bridge);

	txc_48352_exit(priv);
}
EXPORT_SYMBOL_GPL(txc_48352_remove);
