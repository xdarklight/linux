...
#define TX_VIDEO_DTV_OPTION_L						0x0048
	#define TX_VIDEO_DTV_OPTION_L_COLOR_FORMAT_RGB444		0x0
	#define TX_VIDEO_DTV_OPTION_L_COLOR_FORMAT_YCBCR444		0x1
	#define TX_VIDEO_DTV_OPTION_L_COLOR_FORMAT_YCBCR422		0x3
	#define TX_VIDEO_DTV_OPTION_L_OUTPUT_COLOR_FORMAT	GENMASK(7, 6)
	#define TX_VIDEO_DTV_OPTION_L_INPUT_COLOR_FORMAT	GENMASK(5, 4)
	#define TX_VIDEO_DTV_OPTION_L_COLOR_DEPTH_24_BIT		0x0
	#define TX_VIDEO_DTV_OPTION_L_COLOR_DEPTH_30_BIT		0x1
	#define TX_VIDEO_DTV_OPTION_L_COLOR_DEPTH_36_BIT		0x2
	#define TX_VIDEO_DTV_OPTION_L_COLOR_DEPTH_48_BIT		0x3
