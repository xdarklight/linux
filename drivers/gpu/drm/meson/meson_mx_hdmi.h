...
#ifndef __MESON_MX_HDMI_REGS_H__
#define __MESON_MX_HDMI_REGS_H__
...
#define TX_HDCP_BKSV_SHADOW						0x0100
#define TX_HDCP_AKSV_SHADOW						0x0110
...
#define TX_SYS5_TX_SOFT_RESET_2						0x00E1
	#define TX_SYS5_TX_SOFT_RESET_2_UNKNOWN_BIT7			BIT(7)
	#define TX_SYS5_TX_SOFT_RESET_2_UNKNOWN_BIT6			BIT(6)
	#define TX_SYS5_TX_SOFT_RESET_2_UNKNOWN_BIT5			BIT(5)
	#define TX_SYS5_TX_SOFT_RESET_2_HDMI_CH0_RST_IN			BIT(4)
	#define TX_SYS5_TX_SOFT_RESET_2_UNKNOWN_BIT3			BIT(3)
...
#define TX_HDCP_CONFIG0							0x002B
	#define TX_HDCP_CONFIG0_ROM_ENCRYPT_OFF_MASK		GENMASK(4, 3)
...
#define TX_VIDEO_DTV_TIMING						0x003A
	...
	#define TX_VIDEO_DTV_TIMING_UNKNOWN_BIT4			BIT(4)

#define TX_VIDEO_DTV_MODE						0x003B
	#define TX_VIDEO_DTV_MODE_COLOR_DEPTH_MASK		GENMASK(1, 0)
...
#define TX_VIDEO_DTV_OPTION_L						0x0048
	#define TX_VIDEO_DTV_OPTION_L_OUTPUT_COLOR_FORMAT_MASK	GENMASK(7, 6)
	#define TX_VIDEO_DTV_OPTION_L_INPUT_COLOR_FORMAT_MASK	GENMASK(5, 4)
...
#define TX_VIDEO_DTV_OPTION_H						0x0049
	#define TX_VIDEO_DTV_OPTION_H_OUTPUT_COLOR_RANGE_MASK	GENMASK(3, 2)
	#define TX_VIDEO_DTV_OPTION_H_INPUT_COLOR_RANGE_MASK	GENMASK(1, 0)
...
#define TX_TMDS_MODE							0x0068
	...
	#define TX_TMDS_MODE_CHANNEL_SWAP_MASK			GENMASK(2, 0)
...
#define TX_CORE_DATA_CAPTURE_2						0x00F1
	#define TX_CORE_DATA_CAPTURE_2_AUDIO_SOURCE_SELECT_MASK	GENMASK(7, 6)
	#define TX_CORE_DATA_CAPTURE_2_EXTERNAL_PACKET_ENABLE		BIT(5)
	#define TX_CORE_DATA_CAPTURE_2_INTERNAL_PACKET_ENABLE		BIT(4)
	#define TX_CORE_DATA_CAPTURE_2_AFE_FIFO_SRC_LANE1_MASK	GENMASK(3, 2)
	#define TX_CORE_DATA_CAPTURE_2_AFE_FIFO_SRC_LANE0_MASK	GENMASK(1, 0)

#define TX_CORE_DATA_MONITOR_1						0x00F2
	#define TX_CORE_DATA_MONITOR_1_LANE1				BIT(7)
	#define TX_CORE_DATA_MONITOR_1_SELECT_LANE1_MASK	GENMASK(6, 4)
	#define TX_CORE_DATA_MONITOR_1_LANE0				BIT(3)
	#define TX_CORE_DATA_MONITOR_1_SELECT_LANE0_MASK	GENMASK(2, 0)

#define TX_CORE_DATA_MONITOR_2						0x00F3
	#define TX_CORE_DATA_MONITOR_2_MONITOR_SELECT_MASK	GENMASK(2, 0)
...
#endif /* __MESON_MX_HDMI_REGS_H__ */
