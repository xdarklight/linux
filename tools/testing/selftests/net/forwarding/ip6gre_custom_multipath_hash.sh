...
send_src_ipv4()
{
	mz_do $h1 -p 64 -A "198.51.100.2-198.51.100.253" -B 203.0.113.2 \
		-d 1msec -c 50 -t udp "sp=20000,dp=30000"
}

send_dst_ipv4()
{
	mz_do $h1 -p 64 -A 198.51.100.2 -B "203.0.113.2-203.0.113.253" \
		-d 1msec -c 50 -t udp "sp=20000,dp=30000"
}

send_src_udp4()
{
	mz_do $h1 -p 64 -A 198.51.100.2 -B 203.0.113.2 \
...
send_src_ipv6()
{
	mz_do $h1 -6 -p 64 -A "2001:db8:1::2-2001:db8:1::fd" -B 2001:db8:2::2 \
		-d 1msec -c 50 -t udp "sp=20000,dp=30000"
}

send_dst_ipv6()
{
	mz_do $h1 -6 -p 64 -A 2001:db8:1::2 -B "2001:db8:2::2-2001:db8:2::fd" \
		-d 1msec -c 50 -t udp "sp=20000,dp=30000"
}
...
send_src_udp6()
{
	mz_do $h1 -6 -p 64 -A 2001:db8:1::2 -B 2001:db8:2::2 \
		-d 1msec -t udp "sp=0-32768,dp=30000"
}
