...
sip_in_class_e()
{
	...
	mz_do $h1 -t udp "sp=54321,dp=12345" -c 5 -d 1msec \
...
__mc_mac_mismatch()
{
	...
	mz_do $h1 $flags -t udp "sp=54321,dp=12345" -c 5 -d 1msec -b $dmac \
		-B $dip
...
ipv6_sip_equal_dip()
{
	...
	mz_do $h1 -6 -t udp "sp=54321,dp=12345" -c 5 -d 1msec \
...
ipv4_dip_link_local()
{
	...
	mz_do $h1 -t udp "sp=54321,dp=12345" -c 5 -d 1msec -b $rp1mac -B $dip
