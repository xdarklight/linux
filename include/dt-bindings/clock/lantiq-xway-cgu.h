...
#define CGU_GPHY_CLK_36MHZ_XTAL		0	/* XTAL 36 MHz input */
#define CGU_GPHY_CLK_25MHZ_PLL0		1	/* 25 MHz from PLL0 with divider */
#define CGU_GPHY_CLK_24MHZ_PLL2		2	/* derived from PLL2 output (XTAL is 36 MHz) */
#define CGU_GPHY_CLK_25MHZ_GPIO3	3	/* 25 MHz Clock from Pin GPIO3 */
